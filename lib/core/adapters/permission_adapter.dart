...
class TypePermission {
  ...
  static TypePermission manageExternalStorage = TypePermission._(Permission.manageExternalStorage);

  static List<TypePermission> getAllPermissions() => [camera, storage, manageExternalStorage];
}